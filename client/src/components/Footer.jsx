        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition-colors duration-300">Marketing</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-300">Advertisement</a></li>
            </ul>
          </div>
